                  ...
                  <div className="md:col-end-13 md:col-span-8">
                    ...
                    <div className="grid lg:flex flex-wrap items-center gap-y-3 lg:space-x-6 mb-8 md:mb-10">
                      <a
                        ...
                        className="text-primary-500 text-sm font-semibold flex items-center space-x-2"
                      >
                      ...
                      <div className="text-primary-500 text-sm font-semibold flex items-center space-x-2">
                        <div className="w-5 h-5 bg-gray-300 rounded-full"></div>
