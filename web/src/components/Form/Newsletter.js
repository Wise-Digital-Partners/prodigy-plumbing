        ...
        >
          ...
          <div className="w-full">
            ...
            <input
              ...
              required={true}
              className="w-full px-4 h-[48px] rounded-l rounded-r-none border-gray-200"
            />
          </div>
          <ButtonSolid
            type="submit"
            className="!rounded-l-none rounded-r min-w-[112px] h-[48px] before:rounded-l-none before:rounded-r"
            text="Subscribe"
          />
        </form>
      </StyledForm>
